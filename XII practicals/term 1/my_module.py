    ...
    while loop:
        ...
        *********************************************************             
        ...
        if s == 1:
            ...
            print("the volume of rectangle is in cm cube is :", length * b * h)
            ...
            print("TSA of right circular cone is :", 22 / 7 * r * length + 22 / 7 * r ** 2)
            ...
            length = float(input("enter the length of rectangle in cm:"))
            b = float(input("enter the breadth of rectangle in cm:"))
            print("the area of rectangle is in cm square is :", length * b)

        elif s == 11:
            # CSA of a right circular cone
            r = float(input("enter the radius of cone:"))
            length = float(input("enter the length of cone:"))
            print("CSA of right circular cone is :", 22 / 7 * r * length)
